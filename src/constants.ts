...
export const BUILDING_DEFS: Record<BuildingSize, {
  ...
  // score 基準: 小家具 5 を 1 単位として建物は概ね 40-1500、城のみ 10000 (最終報酬)
  house:          { w: 16, h: 20, hp: 1, score:   75, humanMin:  3,  humanMax:  7  },
  convenience:    { w: 24, h: 22, hp: 1, score:  100, humanMin:  8,  humanMax: 15  },
  shop:           { w: 22, h: 25, hp: 1, score:  125, humanMin: 10,  humanMax: 20  },
  restaurant:     { w: 20, h: 28, hp: 1, score:  125, humanMin: 15,  humanMax: 30  },
  apartment:      { w: 24, h: 40, hp: 2, score:  200, humanMin: 20,  humanMax: 40  },
  temple:         { w: 30, h: 30, hp: 2, score:  300, humanMin: 20,  humanMax: 45  },
  parking:        { w: 36, h: 35, hp: 2, score:  150, humanMin: 25,  humanMax: 55  },
  office:         { w: 30, h: 55, hp: 3, score:  450, humanMin: 55,  humanMax: 95  },
  tower:          { w: 35, h: 70, hp: 3, score:  600, humanMin: 70,  humanMax: 120 },
  skyscraper:     { w: 28, h: 90, hp: 3, score: 1000, humanMin: 80,  humanMax: 140 },
  hospital:       { w: 35, h: 50, hp: 3, score:  500, humanMin: 50,  humanMax: 90  },
  school:         { w: 40, h: 45, hp: 3, score:  500, humanMin: 70,  humanMax: 120 },
  // ===== 1-A 住宅系 =====
  townhouse:      { w: 18, h: 24, hp: 1, score:  100, humanMin:  4,  humanMax:  9  },
  mansion:        { w: 32, h: 28, hp: 1, score:  250, humanMin:  6,  humanMax: 16  },
  garage:         { w: 20, h: 14, hp: 1, score:   60, humanMin:  1,  humanMax:  4  },
  shed:           { w: 12, h: 12, hp: 1, score:   40, humanMin:  0,  humanMax:  2  },
  greenhouse:     { w: 22, h: 18, hp: 1, score:   65, humanMin:  2,  humanMax:  6  },
  daycare:        { w: 28, h: 22, hp: 1, score:  110, humanMin: 15,  humanMax: 30  },
  clinic:         { w: 26, h: 28, hp: 1, score:  150, humanMin: 18,  humanMax: 35  },
  shrine:         { w: 26, h: 28, hp: 2, score:  250, humanMin: 15,  humanMax: 35  },
  apartment_tall: { w: 26, h: 58, hp: 3, score:  400, humanMin: 35,  humanMax: 65  },
  // ===== 1-B 商業系 =====
  cafe:           { w: 18, h: 20, hp: 1, score:  100, humanMin: 12,  humanMax: 22  },
  bakery:         { w: 16, h: 18, hp: 1, score:   90, humanMin:  8,  humanMax: 16  },
  bookstore:      { w: 18, h: 22, hp: 1, score:  100, humanMin:  8,  humanMax: 15  },
  pharmacy:       { w: 20, h: 22, hp: 1, score:  100, humanMin:  8,  humanMax: 14  },
  supermarket:    { w: 40, h: 28, hp: 2, score:  250, humanMin: 25,  humanMax: 45  },
  karaoke:        { w: 24, h: 30, hp: 2, score:  200, humanMin: 18,  humanMax: 35  },
  pachinko:       { w: 30, h: 28, hp: 2, score:  200, humanMin: 20,  humanMax: 35  },
  laundromat:     { w: 18, h: 18, hp: 1, score:   75, humanMin:  5,  humanMax: 12  },
  florist:        { w: 14, h: 18, hp: 1, score:   80, humanMin:  5,  humanMax: 10  },
  ramen:          { w: 16, h: 20, hp: 1, score:  100, humanMin: 10,  humanMax: 22  },
  izakaya:        { w: 20, h: 22, hp: 1, score:  110, humanMin: 15,  humanMax: 30  },
  game_center:    { w: 28, h: 26, hp: 2, score:  200, humanMin: 18,  humanMax: 32  },
  // ===== 1-C 公共系 =====
  bank:           { w: 28, h: 32, hp: 2, score:  350, humanMin: 20,  humanMax: 45  },
  post_office:    { w: 24, h: 26, hp: 1, score:  125, humanMin: 12,  humanMax: 25  },
  library:        { w: 36, h: 34, hp: 2, score:  300, humanMin: 25,  humanMax: 55  },
  museum:         { w: 40, h: 38, hp: 2, score:  400, humanMin: 25,  humanMax: 50  },
  city_hall:      { w: 40, h: 44, hp: 3, score:  600, humanMin: 30,  humanMax: 55  },
  fire_station:   { w: 30, h: 30, hp: 2, score:  225, humanMin: 10,  humanMax: 22  },
  police_station: { w: 30, h: 32, hp: 2, score:  250, humanMin: 15,  humanMax: 30  },
  train_station:  { w: 50, h: 36, hp: 3, score:  750, humanMin: 35,  humanMax: 70  },
  movie_theater:  { w: 38, h: 32, hp: 2, score:  350, humanMin: 30,  humanMax: 55  },
  gas_station:    { w: 30, h: 18, hp: 1, score:  150, humanMin:  3,  humanMax:  8  },
  // ===== 1-D ランドマーク =====
  clock_tower:    { w: 16, h: 68, hp: 2, score:  300, humanMin:  5,  humanMax: 12  },
  radio_tower:    { w: 10, h: 88, hp: 3, score:  400, humanMin:  2,  humanMax:  8  },
  ferris_wheel:   { w: 44, h: 48, hp: 3, score:  600, humanMin: 15,  humanMax: 35  },
  stadium:        { w: 60, h: 38, hp: 3, score: 1500, humanMin: 80,  humanMax: 160 },
  water_tower:    { w: 18, h: 48, hp: 1, score:  100, humanMin:  0,  humanMax:  3  },
  // ===== 特大施設 =====
  department_store: { w: 54, h: 38, hp: 3, score: 750, humanMin: 50,  humanMax: 100 },
  // ===== 港湾・工業 (Stage 4) =====
  warehouse:       { w: 52, h: 28, hp: 2, score:  350, humanMin:  8,  humanMax: 20  },
  crane_gantry:    { w: 34, h: 78, hp: 3, score:  600, humanMin:  2,  humanMax:  8  },
  container_stack: { w: 32, h: 30, hp: 2, score:  250, humanMin:  0,  humanMax:  4  },
  factory_stack:   { w: 42, h: 62, hp: 3, score:  700, humanMin: 20,  humanMax: 45  },
  silo:            { w: 20, h: 48, hp: 2, score:  225, humanMin:  0,  humanMax:  3  },
  // ===== 和風・古都 (Stage 3) =====
  pagoda:          { w: 24, h: 72, hp: 3, score:  750, humanMin:  8,  humanMax: 25  },
  ryokan:          { w: 40, h: 30, hp: 2, score:  350, humanMin: 18,  humanMax: 38  },
  kominka:         { w: 22, h: 22, hp: 1, score:  100, humanMin:  4,  humanMax: 10  },
  chaya:           { w: 20, h: 20, hp: 1, score:  110, humanMin: 10,  humanMax: 22  },
  // ===== テーマパーク・祭り (Stage 5) =====
  carousel:        { w: 38, h: 32, hp: 2, score:  450, humanMin: 15,  humanMax: 35  },
  roller_coaster:  { w: 60, h: 60, hp: 3, score: 1100, humanMin: 20,  humanMax: 45  },
  yatai:           { w: 20, h: 16, hp: 1, score:   90, humanMin: 12,  humanMax: 25  },
  big_tent:        { w: 48, h: 36, hp: 2, score:  450, humanMin: 25,  humanMax: 55  },
  // ===== Stage 1 ミニチュア追加 =====
  shotengai_arcade:     { w: 40, h:  6, hp: 1, score: 100, humanMin:  0,  humanMax:  3 },
  bus_terminal_shelter: { w: 32, h: 10, hp: 1, score: 125, humanMin: 15,  humanMax: 30 },
  fountain_pavilion:    { w: 28, h: 14, hp: 2, score: 200, humanMin:  5,  humanMax: 15 },
  // ===== Stage 2 夜街追加 =====
  snack:          { w: 16, h: 22, hp: 1, score:  110, humanMin:  6,  humanMax: 14 },
  love_hotel:     { w: 32, h: 42, hp: 2, score:  275, humanMin: 10,  humanMax: 28 },
  business_hotel: { w: 24, h: 55, hp: 3, score:  400, humanMin: 30,  humanMax: 60  },
  mahjong_parlor: { w: 22, h: 26, hp: 1, score:  140, humanMin:  8,  humanMax: 18 },
  club:           { w: 28, h: 30, hp: 2, score:  240, humanMin: 18,  humanMax:  35 },
  capsule_hotel:  { w: 40, h: 28, hp: 2, score:  300, humanMin: 25,  humanMax:  50 },
  // ===== Stage 3 和風追加 =====
  kura:           { w: 18, h: 20, hp: 1, score:  110, humanMin:  2,  humanMax:  5 },
  machiya:        { w: 24, h: 32, hp: 2, score:  200, humanMin: 15,  humanMax: 30 },
  onsen_inn:      { w: 44, h: 36, hp: 2, score:  450, humanMin: 20,  humanMax: 45 },
  tahoto:         { w: 22, h: 48, hp: 2, score:  500, humanMin:  5,  humanMax: 15 },
  // ===== Stage 3 和風小建物の追加バリエーション =====
  dojo:           { w: 24, h: 24, hp: 1, score:  140, humanMin:  5,  humanMax: 15 },
  wagashi:        { w: 18, h: 20, hp: 1, score:  110, humanMin:  8,  humanMax: 16 },
  kimono_shop:    { w: 22, h: 22, hp: 1, score:  130, humanMin:  6,  humanMax: 14 },
  sushi_ya:       { w: 16, h: 20, hp: 1, score:  120, humanMin: 10,  humanMax: 20 },
  // ===== Stage 1 住宅バリエーション =====
  bungalow:       { w: 22, h: 14, hp: 1, score:   80, humanMin:  3,  humanMax:  6 },
  duplex:         { w: 20, h: 28, hp: 1, score:  140, humanMin:  6,  humanMax: 12 },
  // ===== Stage 5 フィナーレ: ラスボス 象徴のお城 (天守閣) =====
  // hp 高く、巨大、最終破壊でゲームクリアをトリガー
  castle:         { w: 70, h: 110, hp: 6, score: 10000, humanMin: 1800, humanMax: 2200 },
};
