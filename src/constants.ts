...
export const BUILDING_DEFS: Record<BuildingSize, {
  ...
  office:         { w: 30, h: 55, hp: 3, score:  900, humanMin: 55,  humanMax: 95  },
  tower:          { w: 35, h: 70, hp: 3, score: 1200, humanMin: 70,  humanMax: 120 },
  skyscraper:     { w: 28, h: 90, hp: 3, score: 2000, humanMin: 80,  humanMax: 140 },
  hospital:       { w: 35, h: 50, hp: 3, score: 1000, humanMin: 50,  humanMax: 90  },
  school:         { w: 40, h: 45, hp: 3, score: 1000, humanMin: 70,  humanMax: 120 },
  // ===== 1-A 住宅系 =====
  ...
  apartment_tall: { w: 26, h: 58, hp: 3, score:  800, humanMin: 35,  humanMax: 65  },
  // ===== 1-B 商業系 =====
  ...
  city_hall:      { w: 40, h: 44, hp: 3, score: 1200, humanMin: 30,  humanMax: 55  },
  ...
  train_station:  { w: 50, h: 36, hp: 3, score: 1500, humanMin: 35,  humanMax: 70  },
  movie_theater:  { w: 38, h: 32, hp: 2, score:  700, humanMin: 30,  humanMax: 55  },
  ...
  ferris_wheel:   { w: 44, h: 48, hp: 3, score: 1200, humanMin: 15,  humanMax: 35  },
  stadium:        { w: 60, h: 38, hp: 3, score: 3000, humanMin: 80,  humanMax: 160 },
  water_tower:    { w: 18, h: 48, hp: 1, score:  200, humanMin:  0,  humanMax:  3  },
  // ===== 特大施設 =====
  department_store: { w: 54, h: 38, hp: 3, score: 1500, humanMin: 50,  humanMax: 100 },
  // ===== 港湾・工業 (Stage 4) =====
  ...
  factory_stack:   { w: 42, h: 62, hp: 3, score: 1400, humanMin: 20,  humanMax: 45  },
  silo:            { w: 20, h: 48, hp: 2, score:  450, humanMin:  0,  humanMax:  3  },
  // ===== 和風・古都 (Stage 3) =====
  pagoda:          { w: 24, h: 72, hp: 3, score: 1500, humanMin:  8,  humanMax: 25  },
  ryokan:          { w: 40, h: 30, hp: 2, score:  700, humanMin: 18,  humanMax: 38  },
  kominka:         { w: 22, h: 22, hp: 1, score:  200, humanMin:  4,  humanMax: 10  },
  chaya:           { w: 20, h: 20, hp: 1, score:  220, humanMin: 10,  humanMax: 22  },
  // ===== テーマパーク・祭り (Stage 5) =====
  carousel:        { w: 38, h: 32, hp: 2, score:  900, humanMin: 15,  humanMax: 35  },
  roller_coaster:  { w: 60, h: 60, hp: 3, score: 2200, humanMin: 20,  humanMax: 45  },
  yatai:           { w: 20, h: 16, hp: 1, score:  180, humanMin: 12,  humanMax: 25  },
  big_tent:        { w: 48, h: 36, hp: 2, score:  900, humanMin: 25,  humanMax: 55  },
  // ===== Stage 1 ミニチュア追加 =====
  ...
  business_hotel: { w: 24, h: 55, hp: 3, score:  800, humanMin: 30,  humanMax: 60  },
  mahjong_parlor: { w: 22, h: 26, hp: 1, score:  280, humanMin:  8,  humanMax: 18 },
  club:           { w: 28, h: 30, hp: 2, score:  480, humanMin: 18,  humanMax:  35 },
  capsule_hotel:  { w: 40, h: 28, hp: 2, score:  600, humanMin: 25,  humanMax:  50 },
  // ===== Stage 3 和風追加 =====
  kura:           { w: 18, h: 20, hp: 1, score:  220, humanMin:  2,  humanMax:  5 },
  machiya:        { w: 24, h: 32, hp: 2, score:  400, humanMin: 15,  humanMax: 30 },
  onsen_inn:      { w: 44, h: 36, hp: 2, score:  900, humanMin: 20,  humanMax: 45 },
  ...
  castle:         { w: 70, h: 110, hp: 6, score: 20000, humanMin: 1800, humanMax: 2200 },
};
...
export const FUEL_DRAIN_PER_SEC   = 10;   // ベースドレイン; ゲージ量に応じて倍率が掛かる (50% 時 = 10/s の基準)
export const FUEL_DRAIN_MULT_MAX  = 1.8;  // 燃料 100% 時の倍率 → 18/s (満タンほど激しく消費)
export const FUEL_DRAIN_MULT_MIN  = 0.2;  // 燃料 0% 時の倍率 → 2/s (空に近いほど節約)
