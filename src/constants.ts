...
export const BUILDING_DEFS: Record<BuildingSize, {
  ...
  // ===== オリジナル =====
  // hp 4段階: 4(極小→power12で1撃), 8(小→power28), 11(中→power40), 13(大→power48, max damage=13)
  house:          { w: 16, h: 20, hp:  8, score: 100,  humanMin: 3,   humanMax: 7   },
  convenience:    { w: 24, h: 22, hp:  8, score: 120,  humanMin: 3,   humanMax: 7   },
  shop:           { w: 22, h: 25, hp:  8, score: 150,  humanMin: 40,  humanMax: 60  },
  restaurant:     { w: 20, h: 28, hp:  8, score: 130,  humanMin: 40,  humanMax: 60  },
  apartment:      { w: 24, h: 40, hp: 11, score: 300,  humanMin: 40,  humanMax: 65  },
  temple:         { w: 30, h: 30, hp: 11, score: 350,  humanMin: 35,  humanMax: 55  },
  parking:        { w: 36, h: 35, hp: 11, score: 300,  humanMin: 30,  humanMax: 50  },
  office:         { w: 30, h: 55, hp: 13, score: 400,  humanMin: 220, humanMax: 300 },
  tower:          { w: 35, h: 70, hp: 13, score: 600,  humanMin: 240, humanMax: 320 },
  skyscraper:     { w: 28, h: 90, hp: 13, score: 1000, humanMin: 260, humanMax: 350 },
  hospital:       { w: 35, h: 50, hp: 13, score: 500,  humanMin: 200, humanMax: 280 },
  school:         { w: 40, h: 45, hp: 13, score: 550,  humanMin: 260, humanMax: 350 },
  // ===== 1-A 住宅系 =====
  townhouse:      { w: 18, h: 24, hp:  8, score: 120,  humanMin: 4,   humanMax: 10  },
  mansion:        { w: 32, h: 28, hp:  8, score: 280,  humanMin: 8,   humanMax: 18  },
  garage:         { w: 20, h: 14, hp:  4, score: 70,   humanMin: 1,   humanMax: 4   },
  shed:           { w: 12, h: 12, hp:  4, score: 50,   humanMin: 1,   humanMax: 3   },
  greenhouse:     { w: 22, h: 18, hp:  8, score: 100,  humanMin: 2,   humanMax: 6   },
  daycare:        { w: 28, h: 22, hp:  8, score: 160,  humanMin: 25,  humanMax: 45  },
  clinic:         { w: 26, h: 28, hp:  8, score: 220,  humanMin: 25,  humanMax: 45  },
  shrine:         { w: 26, h: 28, hp: 11, score: 280,  humanMin: 18,  humanMax: 35  },
  apartment_tall: { w: 26, h: 58, hp: 13, score: 520,  humanMin: 130, humanMax: 190 },
  // ===== 1-B 商業系 =====
  cafe:           { w: 18, h: 20, hp:  8, score: 120,  humanMin: 15,  humanMax: 30  },
  bakery:         { w: 16, h: 18, hp:  8, score: 110,  humanMin: 12,  humanMax: 22  },
  bookstore:      { w: 18, h: 22, hp:  8, score: 120,  humanMin: 12,  humanMax: 22  },
  pharmacy:       { w: 20, h: 22, hp:  8, score: 130,  humanMin: 18,  humanMax: 30  },
  supermarket:    { w: 40, h: 28, hp: 11, score: 280,  humanMin: 80,  humanMax: 130 },
  karaoke:        { w: 24, h: 30, hp: 11, score: 200,  humanMin: 50,  humanMax: 80  },
  pachinko:       { w: 30, h: 28, hp: 11, score: 200,  humanMin: 60,  humanMax: 90  },
  laundromat:     { w: 18, h: 18, hp:  8, score: 90,   humanMin: 8,   humanMax: 18  },
  florist:        { w: 14, h: 18, hp:  8, score: 90,   humanMin: 8,   humanMax: 16  },
  ramen:          { w: 16, h: 20, hp:  8, score: 110,  humanMin: 15,  humanMax: 28  },
  izakaya:        { w: 20, h: 22, hp:  8, score: 130,  humanMin: 20,  humanMax: 38  },
  game_center:    { w: 28, h: 26, hp: 11, score: 180,  humanMin: 45,  humanMax: 75  },
  // ===== 1-C 公共系 =====
  bank:           { w: 28, h: 32, hp: 11, score: 350,  humanMin: 35,  humanMax: 55  },
  post_office:    { w: 24, h: 26, hp:  8, score: 200,  humanMin: 25,  humanMax: 45  },
  library:        { w: 36, h: 34, hp: 11, score: 300,  humanMin: 45,  humanMax: 75  },
  museum:         { w: 40, h: 38, hp: 11, score: 500,  humanMin: 75,  humanMax: 110 },
  city_hall:      { w: 40, h: 44, hp: 13, score: 600,  humanMin: 90,  humanMax: 140 },
  fire_station:   { w: 30, h: 30, hp: 11, score: 320,  humanMin: 15,  humanMax: 30  },
  police_station: { w: 30, h: 32, hp: 11, score: 380,  humanMin: 25,  humanMax: 45  },
  train_station:  { w: 50, h: 36, hp: 13, score: 600,  humanMin: 140, humanMax: 220 },
  movie_theater:  { w: 38, h: 32, hp: 11, score: 400,  humanMin: 90,  humanMax: 140 },
  gas_station:    { w: 30, h: 18, hp:  4, score: 180,  humanMin: 8,   humanMax: 16  },
  // ===== 1-D ランドマーク =====
  clock_tower:    { w: 16, h: 68, hp: 11, score: 700,  humanMin: 8,   humanMax: 18  },
  radio_tower:    { w: 10, h: 88, hp: 13, score: 800,  humanMin: 3,   humanMax: 8   },
  ferris_wheel:   { w: 44, h: 48, hp: 13, score: 900,  humanMin: 25,  humanMax: 50  },
  stadium:        { w: 60, h: 38, hp: 13, score: 1000, humanMin: 180, humanMax: 360 },
  water_tower:    { w: 18, h: 48, hp:  4, score: 380,  humanMin: 0,   humanMax: 5   },
  // ===== 特大施設 =====
  department_store: { w: 54, h: 38, hp: 13, score: 700,  humanMin: 160, humanMax: 260 },
};
