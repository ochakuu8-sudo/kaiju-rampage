...
const STAGE_1_TEMPLATES: ChunkTemplate[] = [
  ...
  { patternId: 's1_raw', raw: ((): RawChunkBody => {
    ...
    out.humans = [
      // 公園 (子どもと見守る大人)
      _H(90, 175), _H(130, 140), _H(155, 178), 
      _H(60, 178), 
      // 商店利用客
      _H(-45, 58), _H(155, 50),
      _H(80, 30),
  ...
  { patternId: 's1_raw', raw: {
    ...
    humans: [
      // テラス客 (3連) — 各店3-4人
      _H(-132, 158), _H(-112, 138), 
      _H(-22, 158), _H(0, 160), _H(0, 168),
      _H(132, 158), _H(120, 168),
      // テラス両端
      _H(165, 138),
      // 上段 商店利用客
  ...
  { patternId: 's1_raw', raw: {
    ...
    humans: [
      // 校門・校庭 (児童と見守り)
      _H(-120, 68), _H(-135, 145), _H(-20, 165),
      _H(-100, 60),
      // 通学路・横断
      _H(-90, 92),
      // 保育園 送迎
  ...
  { patternId: 's1_raw', raw: {
    ...
    humans: [
      // アーケードの客 (各店フロント)
      _H(-145, 55), _H(-35, 55), _H(95, 55), 
      _H(-130, 60), _H(-160, 70), 
      _H(-75, 70), _H(-22, 70), 
      // アーケードを歩く人
      _H(0, 90), _H(55, 95), _H(110, 90),
      // 裏側 住宅街
      _H(110, 145), _H(50, 158),
      _H(40, 145), _H(75, 168),
    ],
    grounds: [
